...
class Scene {
    public:
        ...
        Hdri* getHdri();
        void update(MTL::CommandBuffer *pCmd, MTL::AccelerationStructure *pAccelerationStructure, float dt, simd::float3 moveDirection, bool enable);
        void updateGeometry();
    ...
    protected:
        ...
        void loadHdri(MTL::Device *pDevice, const char *fileName);
    private:
        Hdri *_pHdri;
